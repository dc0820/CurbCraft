          ...
          <div style={panel}>
            ...
            {isSports && (
              <>
                ...
                <select value={league} onChange={(e) => setLeague(e.target.value as SportsLeague)} style={input}>
                ...
                <div style={{ marginTop: 10 }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: jerseyTexture ? "1px solid rgba(0,0,0,0.15)" : "1px solid transparent",
                    }}
                  >
                ...
                <div style={{ marginTop: 10 }}>
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: tintEnabled ? "1px solid rgba(0,0,0,0.15)" : "1px solid transparent",
                    }}
                  >
                ...
                <div style={sportsRequestBox}>
                  <div style={sportsRequestText}>
                    <strong>Don’t see your team?</strong> Go to{" "}
                    <span style={{ fontWeight: 900 }}>Custom</span> (college, international, multiple teams, etc.).
                  </div>
